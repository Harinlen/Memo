...
/*!
 * \def knGlobal
 * A global pointer referring to the unique global configure manager object.
 */
...
public:
    ...
    /*!
     * \brief A shortcut to extract user configure object.
     * \return The user configure object.
     */
